...
![Cấu hình DHCP Snooping trên Switch](image-12.png)
...
![Cấu hình DAI và Trusted Port](image-16.png)
...
![Router Attack giả mạo IP](image-17.png)

Kết quả lệnh ping từ máy Attack:

![Kết quả ping tĩnh từ Attack](image-18.png)
